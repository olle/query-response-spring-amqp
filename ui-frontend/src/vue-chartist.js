...
export default function (app) {
  ...
  app.component("Chartist", {
      ...
      hasNoData: function hasNoData() {
        return (
          ...
          (this.type !== "Pie" &&
            ...
            this.data.series.every(function (series) {
    ...
    methods: {
      ...
      draw: function draw() {
        this.chart = this.hasNoData
          ? null
          : new this.$chartist[this.type](
              this.$refs.chart,
              this.data,
              this.options,
      ...
      resetEventHandlers: function resetEventHandlers(
        eventHandlers,
        oldEventHandler
      ) {
        if (!this.chart) {
        ...
        try {
          for (
            var _iterator = oldEventHandler[Symbol.iterator](), _step;
        ...
        try {
          for (
            var _iterator2 = eventHandlers[Symbol.iterator](), _step2;
      ...
      setEventHandlers: function setEventHandlers() {
        if (this.chart && this.eventHandlers) {
          ...
          try {
            for (
              var _iterator3 = this.eventHandlers[Symbol.iterator](), _step3;
    ...
    render: function render() {
      ...
      return (0, h)(
        "div",
        {
          ...
          class: [
            this.ratio,
            _defineProperty({}, this.noDataOptions.class, this.hasNoData),
          ],
        },
        children
      );
