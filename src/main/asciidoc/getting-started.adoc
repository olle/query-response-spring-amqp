...
{qr-gh-link}[Github] page, provides a short snippets on the current best way to
...
NOTE: This annotation will do nothing more but to check for the appropriate
      dependencies from {spring-amqp-name} and load, or import, the 
