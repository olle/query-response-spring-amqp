...
to create a responding service.
...
This is the most basic premiss of {qr-prx}, that any string or text term may be
interpreted as a query - it is however up to the publisher to determine what
the query means.

TIP: We've tried to provide information around the {qr-pfx} _protocol_ and
     philosophy in the later chapter on <<The Query/Response Protocol>>.
