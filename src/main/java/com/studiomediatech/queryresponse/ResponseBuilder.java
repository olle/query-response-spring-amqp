...
/**
 * The main entry type for response building, provides static factory methods to create a {@link ChainingResponseBuilder
...
public class ResponseBuilder {
     ...
     *
     * @param responseRegistry
     *            for this builder, never {@code null}
     */
     ...
     *
     * @param <T>
     *            type of the response elements, and the {@code type} argument.
     * @param term
     *            the query to respond to. A {@link String} of up to 255 characters.
     * @param type
     *            of response elements. Any Java type of {@code class} that is published as JSON responses. This will
     *            infer the type of the provided elements.
     *
     * @return a new {@link ChainingResponseBuilder} instance, <strong>never {@code null}</strong>
     *
     * @throws IllegalArgumentException
     *             if the response query {@code term} argument is invalid.
     */
