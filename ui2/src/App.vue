<template>
  ...
  <main>
    ...
    <footer>
      ...
      Olle Törnström -
      <a href="https://github.com/olle/query-response-spring-amqp/blob/master/LICENSE">The Apache License 2.0</a>
    </footer>
  </main>
</template>
