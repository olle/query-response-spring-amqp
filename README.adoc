...
Up front and center - Query/Response puts developers in another mindset. With
lower coupling, as a feature, there's much more room for better component and
service modeling. Autonomy and independence, by design. System evolution and
...
Read more and learn how to user Query/Response in the
https://olle.github.io/query-response-spring-amqp/[online documentation].

Also check out the working link:./examples/[examples] to get started quickly
with Query/Response.
