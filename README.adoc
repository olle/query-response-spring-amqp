...
* `main`              -> Spring Boot 2.3.x.RELEASE
...
Boot that it is built against. For example `0.9.0-SB2_3_5` from the `main`
branch, meaning it was built with the Spring Boot `2.3.5.RELEASE` dependency.
