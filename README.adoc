...
version of Query/Response. Each release will be built with dependencies for
Spring Boot release versions using a qualifier in the version number.

* `0.9.0-SB2_3_4`  => Spring Boot `2.3.4.RELEASE`
* `0.9.0-SB2_2_10` => Spring Boot `2.2.10.RELEASE`
* `0.9.0-SB2_1_17` => Spring Boot `2.1.17.RELEASE`
* `0.9.0-SB1_5_22` => Spring Boot `1.5.22.RELEASE`
